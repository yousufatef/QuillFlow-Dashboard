...
type CustomPasswordInputProps<TFieldValues extends FieldValues = FieldValues> =
        ...
        return (
          <div className='relative'>
            ...
            <button
              ...
              className='absolute top-1/2 ltr:right-4 rtl:left-4 cursor-pointer inline-flex size-8 -translate-y-1/2 items-center justify-center rounded-md text-muted-foreground transition-colors hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50'
