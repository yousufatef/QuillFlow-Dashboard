...
const getFriendlyTypes = (types: string[]) =>
  [...new Set(types.map(getFriendlyType))].join(', ');
        ...
        return (
          <div className='flex flex-col gap-2'>
            <div
              ...
              className={cn(
                'flex cursor-pointer flex-col items-center justify-center gap-3 rounded-lg border-2 border-dashed border-input bg-background px-4 py-6 text-center transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-none aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20',
            ...
            {files.length > 0 ? (
              <ul className='flex flex-col gap-2'>
                {files.map((file, index) => (
                  <li
                    className={cn(
                      'flex items-center justify-between gap-3 rounded-lg border border-input bg-background p-2 shadow-xs',
                      previewClassName,
                    )}
                  ...
                  >
                    ...
                    <button
                      ...
                      className='inline-flex size-8 shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive disabled:pointer-events-none disabled:opacity-50'
                      disabled={isDisabled}
