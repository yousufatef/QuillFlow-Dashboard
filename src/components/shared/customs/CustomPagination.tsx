...
const Pagination = ({
  ...
  return (
    <ShadcnPagination className='justify-start mt-4'>
      <PaginationContent>
        {/* PREVIOUS */}
        <PaginationItem>
          <PaginationLink
          ...
          >
            <ChevronRight
              className={`h-4 w-4 ${isEnglish ? 'rotate-180' : ''}`}
            />
        ...
        <PaginationItem>
          <PaginationLink
            ...
            className={cn(
              'cursor-pointer',
              pageNumber === 1 &&
                'bg-secondary-500 text-white hover:bg-secondary-500 hover:text-white',
            )}
          >
            1
          </PaginationLink>
        ...
        {pageNumber !== 1 && pageNumber !== totalPages && (
          <PaginationItem>
            <PaginationLink
              ...
              isActive
              className='cursor-pointer bg-secondary-500 text-white hover:bg-secondary-500 hover:text-white'
            >
              {pageNumber}
            </PaginationLink>
          </PaginationItem>
