...
import type { BasicInfoFormProps } from "@/types/blog.types";
import { useFormContext } from "react-hook-form";
import { useTranslation } from "react-i18next";

export function BasicInfoForm({ blogData }: BasicInfoFormProps) {
    console.log("🚀 ~ BasicInfoForm ~ blogData:", blogData)
