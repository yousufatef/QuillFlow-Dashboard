...
import { usePublishBlog } from '@/pages/cms/blogs/hooks/usePublishBlog';
import { useDraftBlog } from '@/pages/cms/blogs/hooks/useDraftBlog';
import PageLayout from '@/components/layout/PageLayout';
import { calculateArticleStats } from '@/utils/articleStats';
import { useTranslation } from 'react-i18next';
import { blogFormDefaultValues, getBlogFormSchema, type BlogFormSchema } from '../components/article/blogForm.schema';
...
function CreateBlogPage() {
  ...
  const { draftBlog, isLoading: isDrafting } = useDraftBlog(() => form.reset());
