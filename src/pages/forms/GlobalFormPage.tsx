...
function GlobalFormPage() {
  ...
  return (
    <section className='mx-auto flex w-full max-w-5xl flex-col gap-6'>
      ...
      <FormProvider {...form}>
        <form
          className='grid gap-6 rounded-lg border bg-card p-4 shadow-xs md:grid-cols-2 md:p-6'
          noValidate
          onSubmit={(event) => {
        ...
        >
          ...
          <CustomEmailInput
            ...
            label='Email'
            name='email'
            placeholder='admin@QuillFlow.app'
            required
          />
          ...
          <div className='flex flex-col gap-3 md:col-span-2 sm:flex-row sm:justify-end'>
            ...
            <SubmitButton className='w-full sm:w-auto' label='Save form' />
          </div>
        </form>
      </FormProvider>
    </section>
